...
export function seedSchoolDatabase(db: DatabaseSync) {
  ...
  try {
    ...
    // Opportunities and applications generation disabled per user request (0 active jobs/internships).
    console.log('💼 Job and internship generation omitted (0 opportunities).');
